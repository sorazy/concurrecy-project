...
{
    public static EBODeque<Integer> q = new EBODeque<>();
    ...
    public static void main(String [] args) throws Exception
    {
        ...
        for (int k = 0; k < thread_array.length; k++)
        {
            ...
            for (int j = 0; j < 1000; j++)
            {
                ...
                matches = q.left_array.matchCount.get() + q.left_array.matchCount.get();
                q = new EBODeque<>();
                counter = new AtomicInteger(0);
            }

            total /= 1000;
            System.out.println("Average time to for " + thread_array[k] + " threads to execute " + CALLS + " calls: " + (total / 1000) + "ns");
